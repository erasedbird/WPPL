...
map_name = "kiva_small"
map_path=f"/mnt/home/ruthluvu/WPPL/Benchmark-Archive/2023 Competition/Example Instances/warehouse.domain/maps/{map_name}.map"
...
inbound_locs = get_matching_coordinates(map_path, "i", ["e"])
aisles_locs = get_matching_coordinates(map_path, "a", ["e"])
outbound_locs = get_matching_coordinates(map_path, "o", ["e"])
extra_spawn_locs = get_matching_coordinates(map_path, "o")

breakpoint()
write_into_file(f"/mnt/home/ruthluvu/WPPL/Benchmark-Archive/2023 Competition/Example Instances/warehouse.domain/agents/{map_name}_spawn.agents", spawn_locs)
write_into_file(f"/mnt/home/ruthluvu/WPPL/Benchmark-Archive/2023 Competition/Example Instances/warehouse.domain/agents/{map_name}_inbound.agents", inbound_locs)
write_into_file(f"/mnt/home/ruthluvu/WPPL/Benchmark-Archive/2023 Competition/Example Instances/warehouse.domain/agents/{map_name}_outbound.agents", outbound_locs)
write_into_file(f"/mnt/home/ruthluvu/WPPL/Benchmark-Archive/2023 Competition/Example Instances/warehouse.domain/agents/{map_name}_aisles.agents", aisles_locs)

random.shuffle(spawn_locs)
write_into_file(f"/mnt/home/ruthluvu/WPPL/Benchmark-Archive/2023 Competition/Example Instances/warehouse.domain/agents/{map_name}_{num_agents}.agents", spawn_locs[:num_agents])
...
write_into_file(f"/mnt/home/ruthluvu/WPPL/Benchmark-Archive/2023 Competition/Example Instances/warehouse.domain/tasks/{map_name}.tasks", tasks)
...
for seed in range(16):
    ret=py_driver.run(
        ...
        spawn_locs = f"Benchmark-Archive/2023 Competition/Example Instances/warehouse.domain/agents/{map_name}_spawn.agents",
        inbound_locs = f"/mnt/home/ruthluvu/WPPL/Benchmark-Archive/2023 Competition/Example Instances/warehouse.domain/agents/{map_name}_inbound.agents",
        outbound_locs = f"/mnt/home/ruthluvu/WPPL/Benchmark-Archive/2023 Competition/Example Instances/warehouse.domain/agents/{map_name}_outbound.agents",
        aisles_locs = f"/mnt/home/ruthluvu/WPPL/Benchmark-Archive/2023 Competition/Example Instances/warehouse.domain/agents/{map_name}_aisles.agents",
        agents_path=f"Benchmark-Archive/2023 Competition/Example Instances/warehouse.domain/agents/{map_name}_{num_agents}.agents",
        tasks_path=f"Benchmark-Archive/2023 Competition/Example Instances/warehouse.domain/tasks/{map_name}.tasks",
        ...
        task_assignment_strategy="kiva", # how to assign tasks to agents, no need to change
