...
void MAPFPlanner::initialize(int preprocess_time_limit)
{
    ...
    {
        cerr << "unknown lifelong solver name no rot" << lifelong_solver_name << endl;
        exit(-1);
    }
...
void MAPFPlanner::initialize(int preprocess_time_limit)
{
    ...
    {
        cout << "unknown lifelong solver name rot" << lifelong_solver_name << endl;
        exit(-1);
    }
