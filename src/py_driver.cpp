...
std::string run(const py::kwargs &kwargs)
{
    ...
    std::cout << "GRID STUFF" << grid.agent_home_locations.size() << " " << grid.end_points.size() << "\n";
